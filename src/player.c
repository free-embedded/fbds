...
void noTone() {
    ...
    compareConfig_PWM_buzzer.compareValue = 20000 * ADAPT_TO_48MHZ;
    Timer_A_initCompare(TIMER_A0_BASE, &compareConfig_PWM_buzzer); // For P2.7
...
void tone(int frequencyHz) {
    ...
    /* Initialize compare registers to generate PWM */
    compareConfig_PWM_buzzer.compareValue = 125000 / frequencyHz * ADAPT_TO_48MHZ;
    Timer_A_initCompare(TIMER_A0_BASE, &compareConfig_PWM_buzzer); // For P2.7
